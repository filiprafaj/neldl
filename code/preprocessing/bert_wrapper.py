...
class BertWrapper:
    ...
    def __init__(self, language, size="base", casing="uncased", layer_indices=[-1,-2,-3,-4], with_cls=False, threads=1, batch_size=16):
        ...
        model_path = str(config.base_folder)+"/data/base_data/bert_models/{}-{}-{}".format(language, size, casing)
    ...
    def bert_embeddings(self, sentences):
        ...
        for index, sentence in enumerate(sentences):
            ...
            for i, subword in enumerate(subwords):
                ...
                assertion_message = "{},{}".format(current_token_normalized, subwords_str)
                assert current_token_normalized.startswith(subwords_str), assertion_message
